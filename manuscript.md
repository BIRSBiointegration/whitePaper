...
<small><em>
This manuscript
([permalink](https://BIRSBiointegration.github.io/whitePaper/v/38a936ff1dcf4537d9520af70fe499ce60e64b57/))
was automatically generated
from [BIRSBiointegration/whitePaper@38a936f](https://github.com/BIRSBiointegration/whitePaper/tree/38a936ff1dcf4537d9520af70fe499ce60e64b57)
on July 29, 2020.
</em></small>
...
Nevertheless, and in contrast with scRNAseq, seqFISH (Lubeck 2014; Shah 2016) and many other spatial transcriptomic technologies often pose significant technological challenges and hence the number of profiled genes per cell is usually restricted to a smaller number (10-100s). Although the newer generation of seqFISH technology (called seqFISH+) has greatly enhanced its capacity which can now be used to profile 10,000 genes (Eng 2019), the technology is significantly more complex and costly. As such, it is desirable to develop computational approaches to effectively integrate scRNAseq and seqFISH data analyses. Therefore, this hackathon provided with seqFISH (Zhu 2018) and scRNAseq (Tasic 2016) data corresponding to the mouse visual cortex and challenged to accurately identify cell-types by integrating both datasets. The scRNA-seq data in this hackathon provides transcriptional profiles at a high molecular resolution whereas the seqFISH data yield spatial characterization at a lower molecular resolution that were divided into two key challenges to enalble high-resolution spatial molecular resolution. In this first challenge, this hackathon explored a number of strategies to identify the most likely cell types in the seqfish dataset based on information obtained from the scRNAseq dataset.

...
<small><em>
This manuscript
([permalink](https://BIRSBiointegration.github.io/whitePaper/v/f62da9aedb2bc73bff9759eb1abfc787ea70ab91/))
was automatically generated
from [BIRSBiointegration/whitePaper@f62da9a](https://github.com/BIRSBiointegration/whitePaper/tree/f62da9aedb2bc73bff9759eb1abfc787ea70ab91)
on July 27, 2020.
</em></small>
...
![Overview of analysis. **A** **A spatial network is built from cells' positions and using Voronoi tessellation, and cell types are infered from an SVM trained on scRNAseq data. The neighbors aggregation method computes aggregation statistics like mean or standard deviation on gene expression data for each node and its first order neighbors. This method identifies spatially coherent areas that can contain one or several cell types, and can be used to detect genes whose expression is modulated by spatial factors rather than cell type.**

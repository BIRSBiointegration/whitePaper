...
<small><em>
This manuscript
([permalink](https://BIRSBiointegration.github.io/whitePaper/v/2efbddbea11213e3e73c07732b71f9fe99432e0e/))
was automatically generated
from [BIRSBiointegration/whitePaper@2efbddb](https://github.com/BIRSBiointegration/whitePaper/tree/2efbddbea11213e3e73c07732b71f9fe99432e0e)
on August 24, 2020.
</em></small>
...
Benchmark datasets, analysis pipelines, and development of multimodal genome-scale experiments are all enabled through community-developed, open source software and data sharing platforms.  Our hackathons were designed to leverage and build on these open frameworks to enable the use and evaluation of robust benchmark strategies, and to support the enhancement and extension of the components themselves. Specifically, we provided easy to use data packages to distribute the multi-omics data, and we developed vignettes that reproducibly demonstrate each of the analysis approaches employed for these datasets (https://github.com/BIRSBiointegration/Hackathon). Data structures and vignettes for the hackathons were largely developed on the R/Bioconductor ecosystem for reproducible, open-source, open development genomic analysis. In this section, we reflect on the software infrastructure that enabled our analytic frameworks for inference and visualization of the multimodal single-cell experiments.  Additionally, we discuss unmet challenges identified through the hackathons, that require future development. A wide array of open-source genomics frameworks for multi-platform single cell data are also developing in R, Python, and in other software frameworks that enable graphical user interfaces for point-and-click exploration. Exploration and engagement with all these tools is richly enabled through code sharing resources like GitHub.

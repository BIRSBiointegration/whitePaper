...
<small><em>
This manuscript
([permalink](https://BIRSBiointegration.github.io/whitePaper/v/24a7ad5005222af865d259dd7b0951085adcd84d/))
was automatically generated
from [BIRSBiointegration/whitePaper@24a7ad5](https://github.com/BIRSBiointegration/whitePaper/tree/24a7ad5005222af865d259dd7b0951085adcd84d)
on August 24, 2020.
</em></small>
...
be feasible, respecting needs for stability, reliability, and continuity of access to evolving components. To that end, exploration and engagement with all these tools is richly enabled through code sharing resources like GitHub. As an example of this, the data structures and vignettes for the hackathons were largely developed on the R/Bioconductor ecosystem for reproducible, open-source, open development genomic analysis. The further community engagement and communication from the workshop were critical to identify key software goals for multi-omics. In this section, we reflect on the software infrastructure that enabled our analytic frameworks for inference and visualization of the multimodal single-cell experiments. Notably, the analysis approaches in the hackathons highlighted the following central challenges that require further development. 

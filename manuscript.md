...
<small><em>
This manuscript
([permalink](https://BIRSBiointegration.github.io/whitePaper/v/9205e2b5f62a212796443e08c58d57dc8f1a54de/))
was automatically generated
from [BIRSBiointegration/whitePaper@9205e2b](https://github.com/BIRSBiointegration/whitePaper/tree/9205e2b5f62a212796443e08c58d57dc8f1a54de)
on August 4, 2020.
</em></small>
...
The application of novel comptuational frameworks for multi-omics analysis requires software tools to enable their broad dissemination. The genomics community at large has facilitated this ease of application through community-developed, open source software and data sharing platforms that have become analysis standards. Our hackathons were designed to leverage and build on these standards, both providing easy to use data packages to distribute the multi-omics data and documented vignettes for each of the analysis approaches employed for these datasets (https://github.com/BIRSBiointegration/Hackathon). These open-source tools provide a critical resource to enable the implementation of robust benchmark strategies, future applications of these methods, and building blocks for subsequent extensions. Both were largely developed on the R/Bioconductor ecosystem for reproducible, open-source genomics software. In this section, we reflect on the software infrastructure that enabled the analytic frameworks for inference and visualization of the multimodal single-cell experiments in the hackathons as well as unmet challenges that require future developments illustrated through the hackathons. While we focus primarily on R/Bioconductor tools because of their selection for our hackathons, we note that a wide array of complementary open-source genomics frameworks for multi-platform single cell data are also developing in python and with other software frameworks that enable graphical user interfaces for point-and-click exploration distributed through code sharing resources including notably GitHub.

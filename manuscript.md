...
<small><em>
This manuscript
([permalink](https://BIRSBiointegration.github.io/whitePaper/v/edbca3a716cc3b43d4781ce936edb006b035ed9a/))
was automatically generated
from [BIRSBiointegration/whitePaper@edbca3a](https://github.com/BIRSBiointegration/whitePaper/tree/edbca3a716cc3b43d4781ce936edb006b035ed9a)
on September 4, 2020.
</em></small>
...
Caption figure: **A** Schematic diagram of stages of interpretation and integration of data sources.
**B** Common standards in Geographic Information Systems (GIS) enable facile integration of multiple layers of data.
**C** Integrative analysis across multiple approaches and modes of data may yield complementary evidence, allowing researchers to draw stronger conclusions (an instance of Cardinal Newman's principle).
...
disparate sources of evidence, or in this case data from different technologies, are more compelling than many replicates of the same technology (illustrated schematically in Figure {@fig:interpretation}C).
Thus, if different technologies are in consensus on underlying latent variables, the finding is more credible.
...
**This part is no longer relevant given figure updates**

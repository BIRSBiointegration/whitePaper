...
<small><em>
This manuscript
([permalink](https://BIRSBiointegration.github.io/whitePaper/v/376352e7f1ef641b11f5b4219ab7e9d5896f95bf/))
was automatically generated
from [BIRSBiointegration/whitePaper@376352e](https://github.com/BIRSBiointegration/whitePaper/tree/376352e7f1ef641b11f5b4219ab7e9d5896f95bf)
on August 24, 2020.
</em></small>
...
We take it for granted that __openness__ is a _sine qua non_ for computational tooling in 
...
to support collaboration rather than duplication of effort between groups working on similar problems. As an example of this, the data structures and vignettes for the hackathons were largely developed on the R/Bioconductor ecosystem for reproducible, open-source, open development genomic analysis. In this section, we reflect on the software infrastructure that enabled our analytic frameworks for inference and visualization of the multimodal single-cell experiments.  Additionally, we discuss unmet challenges identified through the hackathons, that require future development. 

### Key questions

A wide array of open-source genomics frameworks for multi-platform single cell data are also developing in R, Python, and in other software frameworks that enable graphical user interfaces for point-and-click exploration. Real-time improvements to the tool-set should
be feasible, respecting needs for stability, reliability, and continuity of access to evolving components. To that end, exploration and engagement with all these tools is richly enabled through code sharing resources like GitHub. The further community engagement and communication from the workshop were critical to identify key software goals for multi-omics. Specifically, the analysis approaches in the hackthons highlighted the following central challenges.
...
~ __Elana - this seems out of scope of this particular workshop. I would vote for cutting but want feedback from the group before doing so.__ These questions will ultimately be answered through the creation of a __software ecosystem__ [@doi:10.1126/science.aaf6162; @https://chaoss.github.io/grimoirelab/; @http://ceur-ws.org/Vol-987/3.pdf].
